...
class JobPostActivity(models.Model):
    ...
    status = models.ForeignKey(Status,default=2, on_delete=models.SET_NULL, null=True)
    apply_date = models.DateTimeField(auto_now_add=True)
    employment_status = models.ForeignKey('JobEmployment', on_delete=models.SET_NULL, null=True)
...
class JobPostActivityChecked(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    job_post_stated = models.ForeignKey(JobPostActivity, on_delete=models.SET_NULL, null=True)
